...
<head>
    ...
    <!-- Title Page-->
    <title>Patient Register II</title>
                       ...
                       <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Patient Address</label>
                                    <input class="input--style-4" type="text" name="add">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Patient Phone Number</label>
                                    <input class="input--style-4" type="text" name="phone" placeholder="000-000-0000">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Emergency Contact First Name</label>
                                    <input class="input--style-4" type="text" name="fname">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Emergency Contact Last Name</label>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Emergency Contact Phone Number </label>
                                    <input class="input--style-4" type="text" name="phone" placeholder="000-000-0000">
                                </div>
                            </div>
                        </div>
